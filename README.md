...
- Two feature vector {blur,edges} is used to train the svm classifier 


## ScreenShot
  ![ScreenShot](https://github.com/sonuauti/face-spoof-detection/blob/master/app/src/main/res/drawable/fake.png){:height="50%" width="50%"}
